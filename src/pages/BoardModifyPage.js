...
import BoardModifyConfirmPage from './BoardModifyConfirmPage';
import { Link } from "react-router-dom";
...
function BoardWritePage(){   
    ...
    return(
        <div>
            ...
            <BoardUI >
                <div id="main" style={{display:"block", margin: "0 0 0 0", position:"relative", width:"100%", height: "0vh", justifyContent:"center", opacity:"0.98"}}>
                <img src={board_bg} alt=''></img></div>
                <div>
                    <BoardModifyConfirmPage style={{position: 'absolute', zIndex:'100'}} open={openModal} onClose={()=>setOpenModal(false)}></BoardModifyConfirmPage>
                </div>
                <BoardTableContainer style={{position:"relative", margin:"100px 10% 0px 42%"}}>
                ...
                <TableContainer>
                    ...
                    <tfoot>
                        {/* <Link to='/board/contentview' style={{textDecoration: 'none'}}> */}
                            <ButtonContainer>
                                <Link to='/board/contentview'>
                                <StyledButton>이전</StyledButton>
                                </Link>
                                <Link>
                                <StyledButton  onClick={()=>{setOpenModal(true)}}>수정하기</StyledButton>
                                </Link>
                            </ButtonContainer>                        
                        {/* </Link>                         */}
                    </tfoot>
